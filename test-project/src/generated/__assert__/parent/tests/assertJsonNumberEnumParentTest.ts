import type { JsonNumberEnumParentTest as __type___parent_tests_JsonNumberEnumParentTest } from "../../../__type__/parent/tests/JsonNumberEnumParentTest.js"
...
export function assertJsonNumberEnumParentTest( o: any, isNullable : true   , path?: string ): asserts o is __type___parent_tests_JsonNumberEnumParentTest | null | undefined
export function assertJsonNumberEnumParentTest( o: any, isNullable?: boolean, path?: string ): asserts o is __type___parent_tests_JsonNumberEnumParentTest
export function assertJsonNumberEnumParentTest( o: any, isNullable?: boolean, path : string = '__type___parent_tests_JsonNumberEnumParentTest' ) {
	if (o == null) {
		if (!isNullable) {
			throw new __assert_utility___AssertionError(`Expected __type___parent_tests_JsonNumberEnumParentTest, got null (at ${path})`)
		}
	} else {
		if (typeof o !== 'object') {
			throw new __assert_utility___AssertionError(
				`Expected __type___parent_tests_JsonNumberEnumParentTest, got ${typeof o} (at ${path})`,
			)
		}
		__assert___parent_assertJsonNumberEnum(
			o.enum_,
			false,
			path + `.enum_:parent_JsonNumberEnum`
		)
		__assert___parent_assertJsonNumberEnum(
			o.enumWithDescription,
			false,
			path + `.enumWithDescription:parent_JsonNumberEnum`
		)
		__assert___parent_assertJsonNumberEnum(
			o.enumOrNull,
			true,
			path + `.enumOrNull:parent_JsonNumberEnum`
		)
		__assert_utility___assertArray(
			(value, path) => __assert___parent_assertJsonNumberEnum(
				value,
				false,
				path
			),
