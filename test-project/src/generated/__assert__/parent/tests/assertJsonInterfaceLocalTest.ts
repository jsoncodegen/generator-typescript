...
import { JsonInterfaceLocalTest as __type___parent_tests_JsonInterfaceLocalTest } from "../../../__type__/parent/tests/JsonInterfaceLocalTest"
...
export function assertJsonInterfaceLocalTest( o: any, isNullable : true   , path?: string ): asserts o is __type___parent_tests_JsonInterfaceLocalTest | null | undefined
export function assertJsonInterfaceLocalTest( o: any, isNullable?: boolean, path?: string ): asserts o is __type___parent_tests_JsonInterfaceLocalTest
export function assertJsonInterfaceLocalTest( o: any, isNullable?: boolean, path : string = '__type___parent_tests_JsonInterfaceLocalTest' ) {
	if (o == null) {
		if (!isNullable) {
			throw new __assert_utility___AssertionError(`Expected __type___parent_tests_JsonInterfaceLocalTest, got null (at ${path})`)
		}
	} else {
		if (typeof o !== 'object') {
			throw new __assert_utility___AssertionError(
				`Expected __type___parent_tests_JsonInterfaceLocalTest, got ${typeof o} (at ${path})`,
			)
		}
		...
		__assert_utility___assertArray(
			(value, path) => __assert___parent_tests_assertJsonInterface(
				value,
				false,
				path
			),
