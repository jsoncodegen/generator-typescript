import type { JsonStringEnumLocalTest as __type___parent_tests_JsonStringEnumLocalTest } from "../../../__type__/parent/tests/JsonStringEnumLocalTest.js"
...
export function assertJsonStringEnumLocalTest( o: any, isNullable : true   , path?: string ): asserts o is __type___parent_tests_JsonStringEnumLocalTest | null | undefined
export function assertJsonStringEnumLocalTest( o: any, isNullable?: boolean, path?: string ): asserts o is __type___parent_tests_JsonStringEnumLocalTest
export function assertJsonStringEnumLocalTest( o: any, isNullable?: boolean, path : string = '__type___parent_tests_JsonStringEnumLocalTest' ) {
	if (o == null) {
		if (!isNullable) {
			throw new __assert_utility___AssertionError(`Expected __type___parent_tests_JsonStringEnumLocalTest, got null (at ${path})`)
		}
	} else {
		if (typeof o !== 'object') {
			throw new __assert_utility___AssertionError(
				`Expected __type___parent_tests_JsonStringEnumLocalTest, got ${typeof o} (at ${path})`,
			)
		}
		__assert___parent_tests_assertJsonStringEnum(
			o.enum_,
			false,
			path + `.enum_:parent_tests_JsonStringEnum`
		)
		__assert___parent_tests_assertJsonStringEnum(
			o.enumWithDescription,
			false,
			path + `.enumWithDescription:parent_tests_JsonStringEnum`
		)
		__assert___parent_tests_assertJsonStringEnum(
			o.enumOrNull,
			true,
			path + `.enumOrNull:parent_tests_JsonStringEnum`
		)
		__assert_utility___assertArray(
			(value, path) => __assert___parent_tests_assertJsonStringEnum(
				value,
				false,
				path
			),
