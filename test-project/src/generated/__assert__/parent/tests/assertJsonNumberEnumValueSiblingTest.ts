...
export function assertJsonNumberEnumValueSiblingTest( o: any, isNullable : true   , path?: string ): asserts o is __type___parent_tests_JsonNumberEnumValueSiblingTest | null | undefined
export function assertJsonNumberEnumValueSiblingTest( o: any, isNullable?: boolean, path?: string ): asserts o is __type___parent_tests_JsonNumberEnumValueSiblingTest
export function assertJsonNumberEnumValueSiblingTest( o: any, isNullable?: boolean, path : string = '__type___parent_tests_JsonNumberEnumValueSiblingTest' ) {
	if (o == null) {
		if (!isNullable) {
			throw new __assert_utility___AssertionError(`Expected __type___parent_tests_JsonNumberEnumValueSiblingTest, got null (at ${path})`)
		}
	} else {
		if (typeof o !== 'object') {
			throw new __assert_utility___AssertionError(
				`Expected __type___parent_tests_JsonNumberEnumValueSiblingTest, got ${typeof o} (at ${path})`,
			)
		}
		__assert_utility___assertExactValue(
			...
			o.enumValue,
			false,
			path + `.enumValue:parent_sibling_JsonNumberEnum:Name`
		)
		__assert_utility___assertExactValue(
			parent_sibling_JsonNumberEnum.Name,
			o.enumValueWithDescription,
			false,
			path + `.enumValueWithDescription:parent_sibling_JsonNumberEnum:Name`
		)
		__assert_utility___assertExactValue(
			parent_sibling_JsonNumberEnum.Name,
			o.enumValueOrNull,
			true,
			path + `.enumValueOrNull:parent_sibling_JsonNumberEnum:Name`
		)
