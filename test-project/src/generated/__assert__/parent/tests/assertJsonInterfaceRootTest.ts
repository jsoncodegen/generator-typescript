import type { JsonInterfaceRootTest as __type___parent_tests_JsonInterfaceRootTest } from "../../../__type__/parent/tests/JsonInterfaceRootTest.js"
...
export function assertJsonInterfaceRootTest( o: any, isNullable : true   , path?: string ): asserts o is __type___parent_tests_JsonInterfaceRootTest | null | undefined
export function assertJsonInterfaceRootTest( o: any, isNullable?: boolean, path?: string ): asserts o is __type___parent_tests_JsonInterfaceRootTest
export function assertJsonInterfaceRootTest( o: any, isNullable?: boolean, path : string = '__type___parent_tests_JsonInterfaceRootTest' ) {
	if (o == null) {
		if (!isNullable) {
			throw new __assert_utility___AssertionError(`Expected __type___parent_tests_JsonInterfaceRootTest, got null (at ${path})`)
		}
	} else {
		if (typeof o !== 'object') {
			throw new __assert_utility___AssertionError(
				`Expected __type___parent_tests_JsonInterfaceRootTest, got ${typeof o} (at ${path})`,
			)
		}
		...
		__assert_utility___assertArray(
			(value, path) => __assert___assertJsonInterface(
				value,
				false,
				path
			),
