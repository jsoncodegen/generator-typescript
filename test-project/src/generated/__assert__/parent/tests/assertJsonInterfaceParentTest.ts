import type { JsonInterfaceParentTest as __type___parent_tests_JsonInterfaceParentTest } from "../../../__type__/parent/tests/JsonInterfaceParentTest.js"
...
export function assertJsonInterfaceParentTest( o: any, isNullable : true   , path?: string ): asserts o is __type___parent_tests_JsonInterfaceParentTest | null | undefined
export function assertJsonInterfaceParentTest( o: any, isNullable?: boolean, path?: string ): asserts o is __type___parent_tests_JsonInterfaceParentTest
export function assertJsonInterfaceParentTest( o: any, isNullable?: boolean, path : string = '__type___parent_tests_JsonInterfaceParentTest' ) {
	if (o == null) {
		if (!isNullable) {
			throw new __assert_utility___AssertionError(`Expected __type___parent_tests_JsonInterfaceParentTest, got null (at ${path})`)
		}
	} else {
		if (typeof o !== 'object') {
			throw new __assert_utility___AssertionError(
				`Expected __type___parent_tests_JsonInterfaceParentTest, got ${typeof o} (at ${path})`,
			)
		}
		...
		__assert_utility___assertArray(
			(value, path) => __assert___parent_assertJsonInterface(
				value,
				false,
				path
			),
