...
export function assertJsonStringEnumValueRootTest( o: any, isNullable : true   , path?: string ): asserts o is __type___parent_tests_JsonStringEnumValueRootTest | null | undefined
export function assertJsonStringEnumValueRootTest( o: any, isNullable?: boolean, path?: string ): asserts o is __type___parent_tests_JsonStringEnumValueRootTest
export function assertJsonStringEnumValueRootTest( o: any, isNullable?: boolean, path : string = '__type___parent_tests_JsonStringEnumValueRootTest' ) {
	if (o == null) {
		if (!isNullable) {
			throw new __assert_utility___AssertionError(`Expected __type___parent_tests_JsonStringEnumValueRootTest, got null (at ${path})`)
		}
	} else {
		if (typeof o !== 'object') {
			throw new __assert_utility___AssertionError(
				`Expected __type___parent_tests_JsonStringEnumValueRootTest, got ${typeof o} (at ${path})`,
			)
		}
		__assert_utility___assertExactValue(
			...
			o.enumValue,
			false,
			path + `.enumValue:JsonStringEnum:Name`
		)
		__assert_utility___assertExactValue(
			JsonStringEnum.Name,
			o.enumValueWithDescription,
			false,
			path + `.enumValueWithDescription:JsonStringEnum:Name`
		)
		__assert_utility___assertExactValue(
			JsonStringEnum.Name,
			o.enumValueOrNull,
			true,
			path + `.enumValueOrNull:JsonStringEnum:Name`
		)
