...
export function assertJsonStringEnumValueLocalTest( o: any, isNullable : true   , path?: string ): asserts o is __type___parent_tests_JsonStringEnumValueLocalTest | null | undefined
export function assertJsonStringEnumValueLocalTest( o: any, isNullable?: boolean, path?: string ): asserts o is __type___parent_tests_JsonStringEnumValueLocalTest
export function assertJsonStringEnumValueLocalTest( o: any, isNullable?: boolean, path : string = '__type___parent_tests_JsonStringEnumValueLocalTest' ) {
	if (o == null) {
		if (!isNullable) {
			throw new __assert_utility___AssertionError(`Expected __type___parent_tests_JsonStringEnumValueLocalTest, got null (at ${path})`)
		}
	} else {
		if (typeof o !== 'object') {
			throw new __assert_utility___AssertionError(
				`Expected __type___parent_tests_JsonStringEnumValueLocalTest, got ${typeof o} (at ${path})`,
			)
		}
		__assert_utility___assertExactValue(
			...
			o.enumValue,
			false,
			path + `.enumValue:parent_tests_JsonStringEnum:Name`
		)
		__assert_utility___assertExactValue(
			parent_tests_JsonStringEnum.Name,
			o.enumValueWithDescription,
			false,
			path + `.enumValueWithDescription:parent_tests_JsonStringEnum:Name`
		)
		__assert_utility___assertExactValue(
			parent_tests_JsonStringEnum.Name,
			o.enumValueOrNull,
			true,
			path + `.enumValueOrNull:parent_tests_JsonStringEnum:Name`
		)
