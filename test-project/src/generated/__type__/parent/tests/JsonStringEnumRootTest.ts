...
export interface JsonStringEnumRootTest {
	...
	readonly arrayOfArraysOfEnums: (readonly (readonly __type___JsonStringEnum[])[])
	...
	readonly mapOfMapsOfEnums: { readonly [key: string]: { readonly [key: string]: __type___JsonStringEnum } }
