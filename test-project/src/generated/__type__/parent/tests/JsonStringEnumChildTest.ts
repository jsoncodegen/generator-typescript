...
export interface JsonStringEnumChildTest {
	...
	readonly arrayOfArraysOfEnums: (readonly (readonly __type___parent_tests_child_JsonStringEnum[])[])
	...
	readonly mapOfMapsOfEnums: { readonly [key: string]: { readonly [key: string]: __type___parent_tests_child_JsonStringEnum } }
