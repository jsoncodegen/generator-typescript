...
export interface JsonNumberEnumValueRootTest {
	...
	readonly arrayOfArraysOfEnumValues: (readonly (readonly __type___JsonNumberEnum.Name[])[])
	...
	readonly mapOfMapsOfEnumValues: { readonly [key: string]: { readonly [key: string]: __type___JsonNumberEnum.Name } }
