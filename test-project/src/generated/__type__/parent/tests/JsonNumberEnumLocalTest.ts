...
export interface JsonNumberEnumLocalTest {
	...
	readonly arrayOfArraysOfEnums: (readonly (readonly __type___parent_tests_JsonNumberEnum[])[])
	...
	readonly mapOfMapsOfEnums: { readonly [key: string]: { readonly [key: string]: __type___parent_tests_JsonNumberEnum } }
