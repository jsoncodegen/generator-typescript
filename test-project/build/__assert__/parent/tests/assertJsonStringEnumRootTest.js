...
function assertJsonStringEnumRootTest(o, isNullable, path) {
    if (path === void 0) { path = '__type___parent_tests_JsonStringEnumRootTest'; }
    if (o == null) {
        if (!isNullable) {
            throw new AssertionError_1.AssertionError("Expected __type___parent_tests_JsonStringEnumRootTest, got null (at " + path + ")");
        }
    }
    else {
        if (typeof o !== 'object') {
            throw new AssertionError_1.AssertionError("Expected __type___parent_tests_JsonStringEnumRootTest, got " + typeof o + " (at " + path + ")");
        }
        assertJsonStringEnum_1.assertJsonStringEnum(o.enum_, false, path + ".enum_:JsonStringEnum");
        assertJsonStringEnum_1.assertJsonStringEnum(o.enumWithDescription, false, path + ".enumWithDescription:JsonStringEnum");
        assertJsonStringEnum_1.assertJsonStringEnum(o.enumOrNull, true, path + ".enumOrNull:JsonStringEnum");
...
exports.assertJsonStringEnumRootTest = assertJsonStringEnumRootTest;
