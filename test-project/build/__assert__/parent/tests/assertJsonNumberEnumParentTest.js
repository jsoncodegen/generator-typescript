...
function assertJsonNumberEnumParentTest(o, isNullable, path) {
    if (path === void 0) { path = '__type___parent_tests_JsonNumberEnumParentTest'; }
    if (o == null) {
        if (!isNullable) {
            throw new AssertionError_1.AssertionError("Expected __type___parent_tests_JsonNumberEnumParentTest, got null (at " + path + ")");
        }
    }
    else {
        if (typeof o !== 'object') {
            throw new AssertionError_1.AssertionError("Expected __type___parent_tests_JsonNumberEnumParentTest, got " + typeof o + " (at " + path + ")");
        }
        assertJsonNumberEnum_1.assertJsonNumberEnum(o.enum_, false, path + ".enum_:parent_JsonNumberEnum");
        assertJsonNumberEnum_1.assertJsonNumberEnum(o.enumWithDescription, false, path + ".enumWithDescription:parent_JsonNumberEnum");
        assertJsonNumberEnum_1.assertJsonNumberEnum(o.enumOrNull, true, path + ".enumOrNull:parent_JsonNumberEnum");
...
exports.assertJsonNumberEnumParentTest = assertJsonNumberEnumParentTest;
