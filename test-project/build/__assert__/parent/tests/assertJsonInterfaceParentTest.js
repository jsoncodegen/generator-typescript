...
function assertJsonInterfaceParentTest(o, isNullable, path) {
    if (path === void 0) { path = '__type___parent_tests_JsonInterfaceParentTest'; }
    if (o == null) {
        if (!isNullable) {
            throw new AssertionError_1.AssertionError("Expected __type___parent_tests_JsonInterfaceParentTest, got null (at " + path + ")");
        }
    }
    else {
        if (typeof o !== 'object') {
            throw new AssertionError_1.AssertionError("Expected __type___parent_tests_JsonInterfaceParentTest, got " + typeof o + " (at " + path + ")");
        }
...
exports.assertJsonInterfaceParentTest = assertJsonInterfaceParentTest;
