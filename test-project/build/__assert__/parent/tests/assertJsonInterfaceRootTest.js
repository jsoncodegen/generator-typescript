...
function assertJsonInterfaceRootTest(o, isNullable, path) {
    if (path === void 0) { path = '__type___parent_tests_JsonInterfaceRootTest'; }
    if (o == null) {
        if (!isNullable) {
            throw new AssertionError_1.AssertionError("Expected __type___parent_tests_JsonInterfaceRootTest, got null (at " + path + ")");
        }
    }
    else {
        if (typeof o !== 'object') {
            throw new AssertionError_1.AssertionError("Expected __type___parent_tests_JsonInterfaceRootTest, got " + typeof o + " (at " + path + ")");
        }
...
exports.assertJsonInterfaceRootTest = assertJsonInterfaceRootTest;
