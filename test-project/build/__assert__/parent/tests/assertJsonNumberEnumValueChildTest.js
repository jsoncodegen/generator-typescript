...
var JsonNumberEnum_1 = require("../../../__type__/parent/tests/child/JsonNumberEnum");
...
function assertJsonNumberEnumValueChildTest(o, isNullable, path) {
    if (path === void 0) { path = '__type___parent_tests_JsonNumberEnumValueChildTest'; }
    if (o == null) {
        if (!isNullable) {
            throw new AssertionError_1.AssertionError("Expected __type___parent_tests_JsonNumberEnumValueChildTest, got null (at " + path + ")");
        }
    }
    else {
        if (typeof o !== 'object') {
            throw new AssertionError_1.AssertionError("Expected __type___parent_tests_JsonNumberEnumValueChildTest, got " + typeof o + " (at " + path + ")");
        }
        assertExactValue_1.assertExactValue(JsonNumberEnum_1.JsonNumberEnum.Name, o.enumValue, false, path + ".enumValue:parent_tests_child_JsonNumberEnum:Name");
        assertExactValue_1.assertExactValue(JsonNumberEnum_1.JsonNumberEnum.Name, o.enumValueWithDescription, false, path + ".enumValueWithDescription:parent_tests_child_JsonNumberEnum:Name");
        assertExactValue_1.assertExactValue(JsonNumberEnum_1.JsonNumberEnum.Name, o.enumValueOrNull, true, path + ".enumValueOrNull:parent_tests_child_JsonNumberEnum:Name");
...
exports.assertJsonNumberEnumValueChildTest = assertJsonNumberEnumValueChildTest;
