...
var assertJsonStringEnum_1 = require("../sibling/assertJsonStringEnum");
var assertMap_1 = require("../../../__assert_utility__/assertMap");
function assertJsonStringEnumSiblingTest(o, isNullable, path) {
    if (path === void 0) { path = '__type___parent_tests_JsonStringEnumSiblingTest'; }
    if (o == null) {
        if (!isNullable) {
            throw new AssertionError_1.AssertionError("Expected __type___parent_tests_JsonStringEnumSiblingTest, got null (at " + path + ")");
        }
    }
    else {
        if (typeof o !== 'object') {
            throw new AssertionError_1.AssertionError("Expected __type___parent_tests_JsonStringEnumSiblingTest, got " + typeof o + " (at " + path + ")");
        }
        assertJsonStringEnum_1.assertJsonStringEnum(o.enum_, false, path + ".enum_:parent_sibling_JsonStringEnum");
        assertJsonStringEnum_1.assertJsonStringEnum(o.enumWithDescription, false, path + ".enumWithDescription:parent_sibling_JsonStringEnum");
        assertJsonStringEnum_1.assertJsonStringEnum(o.enumOrNull, true, path + ".enumOrNull:parent_sibling_JsonStringEnum");
...
exports.assertJsonStringEnumSiblingTest = assertJsonStringEnumSiblingTest;
