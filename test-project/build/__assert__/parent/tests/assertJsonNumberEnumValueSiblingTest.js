...
var JsonNumberEnum_1 = require("../../../__type__/parent/sibling/JsonNumberEnum");
...
function assertJsonNumberEnumValueSiblingTest(o, isNullable, path) {
    if (path === void 0) { path = '__type___parent_tests_JsonNumberEnumValueSiblingTest'; }
    if (o == null) {
        if (!isNullable) {
            throw new AssertionError_1.AssertionError("Expected __type___parent_tests_JsonNumberEnumValueSiblingTest, got null (at " + path + ")");
        }
    }
    else {
        if (typeof o !== 'object') {
            throw new AssertionError_1.AssertionError("Expected __type___parent_tests_JsonNumberEnumValueSiblingTest, got " + typeof o + " (at " + path + ")");
        }
        assertExactValue_1.assertExactValue(JsonNumberEnum_1.JsonNumberEnum.Name, o.enumValue, false, path + ".enumValue:parent_sibling_JsonNumberEnum:Name");
        assertExactValue_1.assertExactValue(JsonNumberEnum_1.JsonNumberEnum.Name, o.enumValueWithDescription, false, path + ".enumValueWithDescription:parent_sibling_JsonNumberEnum:Name");
        assertExactValue_1.assertExactValue(JsonNumberEnum_1.JsonNumberEnum.Name, o.enumValueOrNull, true, path + ".enumValueOrNull:parent_sibling_JsonNumberEnum:Name");
...
exports.assertJsonNumberEnumValueSiblingTest = assertJsonNumberEnumValueSiblingTest;
