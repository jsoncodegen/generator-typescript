...
var assertJsonStringEnum_1 = require("./child/assertJsonStringEnum");
var assertMap_1 = require("../../../__assert_utility__/assertMap");
function assertJsonStringEnumChildTest(o, isNullable, path) {
    if (path === void 0) { path = '__type___parent_tests_JsonStringEnumChildTest'; }
    if (o == null) {
        if (!isNullable) {
            throw new AssertionError_1.AssertionError("Expected __type___parent_tests_JsonStringEnumChildTest, got null (at " + path + ")");
        }
    }
    else {
        if (typeof o !== 'object') {
            throw new AssertionError_1.AssertionError("Expected __type___parent_tests_JsonStringEnumChildTest, got " + typeof o + " (at " + path + ")");
        }
        assertJsonStringEnum_1.assertJsonStringEnum(o.enum_, false, path + ".enum_:parent_tests_child_JsonStringEnum");
        assertJsonStringEnum_1.assertJsonStringEnum(o.enumWithDescription, false, path + ".enumWithDescription:parent_tests_child_JsonStringEnum");
        assertJsonStringEnum_1.assertJsonStringEnum(o.enumOrNull, true, path + ".enumOrNull:parent_tests_child_JsonStringEnum");
...
exports.assertJsonStringEnumChildTest = assertJsonStringEnumChildTest;
