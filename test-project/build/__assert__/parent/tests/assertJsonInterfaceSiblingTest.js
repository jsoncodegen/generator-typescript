...
var assertJsonInterface_1 = require("../sibling/assertJsonInterface");
var assertMap_1 = require("../../../__assert_utility__/assertMap");
function assertJsonInterfaceSiblingTest(o, isNullable, path) {
    if (path === void 0) { path = '__type___parent_tests_JsonInterfaceSiblingTest'; }
    if (o == null) {
        if (!isNullable) {
            throw new AssertionError_1.AssertionError("Expected __type___parent_tests_JsonInterfaceSiblingTest, got null (at " + path + ")");
        }
    }
    else {
        if (typeof o !== 'object') {
            throw new AssertionError_1.AssertionError("Expected __type___parent_tests_JsonInterfaceSiblingTest, got " + typeof o + " (at " + path + ")");
        }
...
exports.assertJsonInterfaceSiblingTest = assertJsonInterfaceSiblingTest;
