...
var assertJsonNumberEnum_1 = require("../sibling/assertJsonNumberEnum");
var assertMap_1 = require("../../../__assert_utility__/assertMap");
function assertJsonNumberEnumSiblingTest(o, isNullable, path) {
    if (path === void 0) { path = '__type___parent_tests_JsonNumberEnumSiblingTest'; }
    if (o == null) {
        if (!isNullable) {
            throw new AssertionError_1.AssertionError("Expected __type___parent_tests_JsonNumberEnumSiblingTest, got null (at " + path + ")");
        }
    }
    else {
        if (typeof o !== 'object') {
            throw new AssertionError_1.AssertionError("Expected __type___parent_tests_JsonNumberEnumSiblingTest, got " + typeof o + " (at " + path + ")");
        }
        assertJsonNumberEnum_1.assertJsonNumberEnum(o.enum_, false, path + ".enum_:parent_sibling_JsonNumberEnum");
        assertJsonNumberEnum_1.assertJsonNumberEnum(o.enumWithDescription, false, path + ".enumWithDescription:parent_sibling_JsonNumberEnum");
        assertJsonNumberEnum_1.assertJsonNumberEnum(o.enumOrNull, true, path + ".enumOrNull:parent_sibling_JsonNumberEnum");
...
exports.assertJsonNumberEnumSiblingTest = assertJsonNumberEnumSiblingTest;
