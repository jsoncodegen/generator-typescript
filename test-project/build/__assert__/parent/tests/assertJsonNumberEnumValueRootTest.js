...
function assertJsonNumberEnumValueRootTest(o, isNullable, path) {
    if (path === void 0) { path = '__type___parent_tests_JsonNumberEnumValueRootTest'; }
    if (o == null) {
        if (!isNullable) {
            throw new AssertionError_1.AssertionError("Expected __type___parent_tests_JsonNumberEnumValueRootTest, got null (at " + path + ")");
        }
    }
    else {
        if (typeof o !== 'object') {
            throw new AssertionError_1.AssertionError("Expected __type___parent_tests_JsonNumberEnumValueRootTest, got " + typeof o + " (at " + path + ")");
        }
        assertExactValue_1.assertExactValue(JsonNumberEnum_1.JsonNumberEnum.Name, o.enumValue, false, path + ".enumValue:JsonNumberEnum:Name");
        assertExactValue_1.assertExactValue(JsonNumberEnum_1.JsonNumberEnum.Name, o.enumValueWithDescription, false, path + ".enumValueWithDescription:JsonNumberEnum:Name");
        assertExactValue_1.assertExactValue(JsonNumberEnum_1.JsonNumberEnum.Name, o.enumValueOrNull, true, path + ".enumValueOrNull:JsonNumberEnum:Name");
...
exports.assertJsonNumberEnumValueRootTest = assertJsonNumberEnumValueRootTest;
