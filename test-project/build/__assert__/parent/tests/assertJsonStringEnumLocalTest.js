...
function assertJsonStringEnumLocalTest(o, isNullable, path) {
    if (path === void 0) { path = '__type___parent_tests_JsonStringEnumLocalTest'; }
    if (o == null) {
        if (!isNullable) {
            throw new AssertionError_1.AssertionError("Expected __type___parent_tests_JsonStringEnumLocalTest, got null (at " + path + ")");
        }
    }
    else {
        if (typeof o !== 'object') {
            throw new AssertionError_1.AssertionError("Expected __type___parent_tests_JsonStringEnumLocalTest, got " + typeof o + " (at " + path + ")");
        }
        assertJsonStringEnum_1.assertJsonStringEnum(o.enum_, false, path + ".enum_:parent_tests_JsonStringEnum");
        assertJsonStringEnum_1.assertJsonStringEnum(o.enumWithDescription, false, path + ".enumWithDescription:parent_tests_JsonStringEnum");
        assertJsonStringEnum_1.assertJsonStringEnum(o.enumOrNull, true, path + ".enumOrNull:parent_tests_JsonStringEnum");
...
exports.assertJsonStringEnumLocalTest = assertJsonStringEnumLocalTest;
