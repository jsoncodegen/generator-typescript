...
function assertJsonStringEnumValueRootTest(o, isNullable, path) {
    if (path === void 0) { path = '__type___parent_tests_JsonStringEnumValueRootTest'; }
    if (o == null) {
        if (!isNullable) {
            throw new AssertionError_1.AssertionError("Expected __type___parent_tests_JsonStringEnumValueRootTest, got null (at " + path + ")");
        }
    }
    else {
        if (typeof o !== 'object') {
            throw new AssertionError_1.AssertionError("Expected __type___parent_tests_JsonStringEnumValueRootTest, got " + typeof o + " (at " + path + ")");
        }
        assertExactValue_1.assertExactValue(JsonStringEnum_1.JsonStringEnum.Name, o.enumValue, false, path + ".enumValue:JsonStringEnum:Name");
        assertExactValue_1.assertExactValue(JsonStringEnum_1.JsonStringEnum.Name, o.enumValueWithDescription, false, path + ".enumValueWithDescription:JsonStringEnum:Name");
        assertExactValue_1.assertExactValue(JsonStringEnum_1.JsonStringEnum.Name, o.enumValueOrNull, true, path + ".enumValueOrNull:JsonStringEnum:Name");
...
exports.assertJsonStringEnumValueRootTest = assertJsonStringEnumValueRootTest;
