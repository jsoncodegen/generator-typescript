...
var JsonStringEnum_1 = require("../../../__type__/parent/tests/JsonStringEnum");
...
function assertJsonStringEnumValueLocalTest(o, isNullable, path) {
    if (path === void 0) { path = '__type___parent_tests_JsonStringEnumValueLocalTest'; }
    if (o == null) {
        if (!isNullable) {
            throw new AssertionError_1.AssertionError("Expected __type___parent_tests_JsonStringEnumValueLocalTest, got null (at " + path + ")");
        }
    }
    else {
        if (typeof o !== 'object') {
            throw new AssertionError_1.AssertionError("Expected __type___parent_tests_JsonStringEnumValueLocalTest, got " + typeof o + " (at " + path + ")");
        }
        assertExactValue_1.assertExactValue(JsonStringEnum_1.JsonStringEnum.Name, o.enumValue, false, path + ".enumValue:parent_tests_JsonStringEnum:Name");
        assertExactValue_1.assertExactValue(JsonStringEnum_1.JsonStringEnum.Name, o.enumValueWithDescription, false, path + ".enumValueWithDescription:parent_tests_JsonStringEnum:Name");
        assertExactValue_1.assertExactValue(JsonStringEnum_1.JsonStringEnum.Name, o.enumValueOrNull, true, path + ".enumValueOrNull:parent_tests_JsonStringEnum:Name");
...
exports.assertJsonStringEnumValueLocalTest = assertJsonStringEnumValueLocalTest;
